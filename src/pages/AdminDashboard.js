...
const styles = {
  container: { minHeight: '100vh', background: 'linear-gradient(135deg, #1561d3 0%, #cc2de4 100%)', padding: '0' },
  header: { background: 'linear-gradient(135deg, #9cacf4 0%, #a159ee 100%)', padding: '20px 30px' },
  headerTitle: { color: 'black', margin: 0, fontSize: '1.8rem' },
  ...
  statNum: { color: '#03081f', fontSize: '2rem', margin: '0 0 5px 0' },
  statLabel: { color: '#0f0101', margin: 0 },
  tabs: { display: 'flex', gap: '10px', padding: '0 30px 20px' },
  tab: { padding: '10px 25px', background: 'white', border: '2px solid #4c62c6', borderRadius: '8px', cursor: 'pointer', color: '#010513', fontSize: '1rem' },
  tabActive: { padding: '10px 25px', background: '#051b79', border: '2px solid #041355', borderRadius: '8px', cursor: 'pointer', color: 'white', fontSize: '1rem' },
  sectionTitle: { color: '#faf9f9', padding: '0 30px', marginBottom: '15px' },
  ...
  cardText: { margin: '4px 0', color: '#080000' },
  actionButtons: { display: 'flex', flexDirection: 'column', gap: '10px' },
  btnConfirm: { padding: '8px 20px', background: '#06661c', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '0.9rem' },
  btnCancel: { padding: '8px 20px', background: '#c92132', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '0.9rem' },
  ...
  input: { padding: '10px', borderRadius: '8px', border: '1px solid #605a5a89', fontSize: '0.9rem', flex: '1', minWidth: '150px' },
  btnAdd: { padding: '10px 20px', background: '#061866', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '0.9rem' },
  ...
  doctorName: { color: '#180202', marginBottom: '8px' },
  doctorSpec: { color: '#01030e', marginBottom: '5px' },
  doctorExp: { color: '#110101', marginBottom: '5px' },
  doctorDays: { color: '#160101', marginBottom: '15px' },
  btnDelete: { padding: '8px 15px', background: '#820713', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', width: '100%' },
